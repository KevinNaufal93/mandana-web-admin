...
// can never 404. On a genuine failure (network, 401, 500) this renders
// the same inline ErrorPanel every list page uses, rather than throwing
...
export default async function EventSupportSettingsPage() {
  ...
  return <EventSupportSettingsForm settings={result.data} />;
}
