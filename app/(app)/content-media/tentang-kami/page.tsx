...
export const metadata: Metadata = { title: "Tentang Kami — Mandana Admin" };

export default async function TentangKamiImagesPage() {
  await requireModule("content-media");
  const page = findPageImagePageBySlug("tentang-kami")!;
