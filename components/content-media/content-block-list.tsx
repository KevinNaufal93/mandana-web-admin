 ...
 * doc. Server Component, same as storage-unit-types-table.tsx — no
 * fetching or hooks here, so it composes fine under the (server) list
 * page.
 */
export function ContentBlockList({ typeDef, rows }: { typeDef: ContentBlockTypeDef; rows: AdminContentBlock[] }) {
  ...
  return (
    <div className={typeDef.layout === "stack" ? "flex flex-col gap-4" : "grid gap-4 sm:grid-cols-2 lg:grid-cols-4"}>
