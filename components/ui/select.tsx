...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      position={position}
      className={cn(
        // bg-card (this app's light surface, #fafafa) + border-border —
        // the closest existing tokens to a "popover", which this theme
        // doesn't define.
        "relative z-50 max-h-96 min-w-[8rem] overflow-hidden rounded-lg border border-border bg-card text-primary shadow-md duration-base ease-standard origin-[--radix-select-content-transform-origin]",
